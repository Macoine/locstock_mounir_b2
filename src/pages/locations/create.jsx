...
const labelStyle = "block font-extrabold text-amber-500 italic overline";
const contentStyle = "block font-light text-red-500 italic";
const contentagainStyle = "block font-light text-white italic";
        ...
        {({ values }) => (
          <Form className="flex flex-col w-1/2 mx-auto gap-4 mt-4">
            <div>
              ...
              <ErrorMessage className={contentStyle} name="nom" component="div" />
            </div>
            <div>
              ...
              <Field
                ...
                className={styles}
              />
              <ErrorMessage className={contentStyle} name="adresse.rue" component="div" />
            </div>
            <div>
              ...
              <Field
                ...
                className={styles}
              />
              <ErrorMessage className={contentStyle} name="adresse.codePostal" component="div" />
            </div>
            <div>
              ...
              <Field
                ...
                className={styles}
              />
              <ErrorMessage className={contentStyle} name="adresse.ville" component="div" />
            </div>
            <div>
              ...
              <Field
                ...
                className={styles}
              />
              <ErrorMessage className={contentStyle} name="adresse.pays" component="div" />
            </div>
            <div>
              ...
              <ErrorMessage className={contentStyle} name="typeDeLieu.type" component="div" />
            </div>
            {values.typeDeLieu.type === "Bar" && (
              <div>
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.typeOfBar">
                    Type de Bar:
                  </label>
                  <Field
                    type="text"
                ...
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.price">Prix:</label>
                  <Field
                    type="number"
            ...
            {values.typeDeLieu.type === "Parc" && (
              <div>
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.typeOfPark">
                    Type de Parc:
                  </label>
                  <Field
                    type="text"
                ...
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.publicOuPrive">
                    Public ou Privé:
                  </label>
                  <Field
                    type="text"
            ...
            {values.typeDeLieu.type === "Parc" && (
              <div>
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.freeOrNot">
                    Gratuit ou Payant:
                  </label>
                  <Field
                    type="number"
            ...
            {values.typeDeLieu.type === "Musee" && (
              <div>
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.courantArtistique">
                    Courant Artistique:
                  </label>
                  <Field
                    type="text"
                ...
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.typeArt">
                    Type d'Art:
                  </label>
                  <Field
                    type="text"
            ...
            {values.typeDeLieu.type === "Restaurant" && (
              <div>
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.typeOfRestaurant">
                    Type de Restaurant:
                  </label>
                  <Field
                    type="text"
                ...
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.nombreEtoiles">
                    Nombre d'Étoiles:
                  </label>
                  <Field
                    type="number"
                ...
                <div>
                  <label className={contentagainStyle} htmlFor="typeDeLieu.details.prixMoyen">
                    Prix Moyen:
                  </label>
                  <Field
                    type="number"
